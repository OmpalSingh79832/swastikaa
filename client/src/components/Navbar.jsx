                ...
                <div className="flex w-full flex-wrap md-lg:gap-8">
                    <div className="w-3/12 md-lg:w-full">
                        <div className="bg-white relative">
                            <div
                                className="h-[50px] bg-[#fc433d] text-black flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
                            >
                                ...
                                <div className="flex h-[50px] items-center relative gap-5">
                                    <div className="relative border border-zinc-500 h-[48px] w-[585px] rounded-l-full">
                                        <div className='relative w-full h-full'>
                                            <input type="text" className='w-full relative bg-transparent text-slate-500 outline-0 pr-2 px-3 h-full rounded-full' placeholder='What You need ' />
                                        </div>
                                    </div>
                                    <button className="bg-[#fc433d] right-0 absolute px-8 h-full font-semibold uppercase text-black rounded-r-full">Search</button>
                                </div>
                            </div>
