        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-start lg:gap-8">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <form className="w-full">
                  ...
                  >
                    <input
                      type="email"
                      id="UserEmail"
                      placeholder="sales@swastikaa.com"
                      className="w-full border-none bg-inherit placeholder:text-white focus:border-transparent focus:ring-transparent sm:text-sm"
                    />

                    <button
                      className="mt-1 w-full font-bold uppercase all-btn sm:mt-0 sm:w-auto sm:shrink-0"
                    >
                      Sign Up
                    </button>
                  </div>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-bold text-2xl text-white">Helpful Links</p>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-bold text-2xl text-white">Legal</p>
              ...
              <div className="col-span-2 sm:col-span-1">
                <p className="font-bold text-2xl text-white">Downloads</p>
