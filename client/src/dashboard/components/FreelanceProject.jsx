...
const FreelanceProject = ({ userRole }) => {
  ...
  return (
    <div className="bg-gray-900 p-6 rounded-lg">
      ...
      {/* Modal */}
      {isModalOpen && (
        <div className="sm:absolute sm:mt-20 md:mt-0 z-50 md:fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-gray-800 text-white p-6 rounded-md sm:w-[90%] md:w-[60%]">
