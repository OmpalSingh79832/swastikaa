    ...
    <div>
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-[92%] mx-auto sm:pt-10 md:py-10">
        ...
        <div className="sm:mt-12 md:mt-16">
          ...
          <h3 className="lg:text-5xl sm:text-2xl lg:leading-tight sm:my-2 md:my-8 font-bold">
            Hiring a designer should be simple
          </h3>
          <p className="lg:text-2xl sm:text-sm leading-snug">
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 sm:w-[90%] mx-auto sm:py-10 md:py-4 sm:flex sm:flex-col-reverse md:flex-row md:py-20">
        <div className="flex flex-col justify-center">
          ...
          <p className="lg:text-2xl sm:text-sm leading-snug">
            ManyPixels provides you with vetted designers for a flat monthly
            fee. No hiring, no contracts, no stress.
          </p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 w-[92%] mx-auto sm:pt-10 md:py-20">
        ...
        <div className="sm:mt-12 md:mt-16">
          ...
          <p className="lg:text-2xl sm:text-sm leading-snug mb-2">
      ...
      <div>
        <div>
          <div className="w-[90%] mx-auto sm:my-10 md:my-16">
            <p className="text-primaryRed text-xl font-semibold mb-4">
              OUR WORK
            </p>
            <h3 className="md:text-5xl sm:text-[30px] font-bold">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 w-[90%] mx-auto mb-10">
            <div className="h-96 relative flex justify-center overflow-hidden rounded-xl cursor-pointer">
              ...
              <img
                ...
                alt="Un"
                className="w-full h-full object-cover rounded-xl transition-transform hover:scale-110 scale-100 duration-300"
              />
