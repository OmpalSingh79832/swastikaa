...
const AboutSec = () => {
  return (
    <div>
      <section class="sm:py-10 md:py-24 relative xl:mr-0 lg:mr-5 mr-0">
              ...
              <div class="w-full flex-col justify-center items-start gap-8 flex">
                <div class="">
                  <div className="text-start">
                    <p className="sm:text-[32px] md:text-[40px] mr-3 font-bold sm:text-center md:text-start">-- About<span className="text-primaryRed">Us --</span></p>
                  </div>
                  <div class="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                    <p
                      class="text-black sm:text-base md:text-lg font-normal leading-relaxed text-start">
